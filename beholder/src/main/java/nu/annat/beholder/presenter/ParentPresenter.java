...
public class ParentPresenter extends ArrayList<Presenter> implements Presenter {
	...
	public ParentPresenter(Collection<Presenter> children) {
		this();
	...
	public ParentPresenter(Presenter... children) {
		this();
		for (Presenter child : children) {
			add(child);
		}
